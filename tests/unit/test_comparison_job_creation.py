...
def test_create_tracking_job_persists_comparison_config_and_user_prompts(client: TestClient, db_session):
    response = client.post(
        ...
        json={
            ...
            "comparison_competitor_brands": ["Merrell"],
            "comparison_prompts": [{"text_en": "Between Salomon and Merrell, which is better?", "language_original": "en"}],
        },
    )
